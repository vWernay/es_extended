...
Locales['pl'] = {
  ...
  ['threw_weapon_already'] = 'już posiadasz na sobie tą broń',
  ['threw_cannot_pickup'] = 'nie możesz tego podnieść ponieważ twój ekwipunek jest pełen!',
  ...
  ['bank'] = 'bank',
  ['account_bank'] = 'konto bankowe',
  ['account_black_money'] = 'brudne pieniądze',
  ['account_money'] = 'gotówka',
  ...
  ['command_car_car'] = 'nazwa lub hash przywolanego pojazdu',
  ['command_cardel'] = 'usuń pojazd w odległości',
  ['command_cardel_radius'] = 'opcjonalnie, usuń każdy pojazd w promieniu',
  ...
  ['command_giveitem_count'] = 'ilość przedmiotu',
  ...
  ['command_save'] = 'zapisz gracza do bazy danych',
  ['command_saveall'] = 'zapisz wszystkich graczy do bazy danych',
  ...
  ['command_setjob_grade'] = 'stopień pracy',
  ...
  -- Identity
  ['identity_register'] = 'Zarejestruj swoją postać.',
  ['identity_welcome'] = 'Witamy, ~b~%s %s',
  ['identity_fill_in'] = 'Przed przesłaniem wypełnij wszystkie pola!',
}
