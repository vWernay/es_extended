...
Locales['br'] = {
  ...
  ['gave_account_money'] = 'voce deu ~g~R$%s~s~ (%s) para ~y~%s~s~',
  ['received_account_money'] = 'voce recebeu ~g~R$%s~s~ (%s) de ~b~%s~s~',
  ...
  ['threw_account'] = 'você jogou ~g~R$%s~s~ ~b~%s~s~',
  ...
  ['received_help'] = 'voce recebeu seu cheque de bem-estar: ~g~R$%s~s~ ',
  ...
  ['command_cardel_radius'] = 'opcional, deleta todos veículos no raio específicado',
  ...
  ['command_giveweapon_hasalready'] = 'jogador já tem está arma',
  ['command_giveweaponcomponent'] = 'dar componente de arma',
  ['command_giveweaponcomponent_component'] = 'nome do componente',
  ['command_giveweaponcomponent_invalid'] = 'componete inválido',
  ['command_giveweaponcomponent_hasalready'] = 'jogador já tem este componente',
  ['command_giveweaponcomponent_missingweapon'] = 'jogador não tem esta arma',
  ['command_save'] = 'salvar jogador na database',
  ['command_saveall'] = 'salvar todos jogadores na database',
  ['command_setaccountmoney'] = 'definir o dinheiro de conta de um jogador',
  ...
  ['command_setgroup'] = 'setar grupo de do jogador',
  ...
  ['commanderror_invaliditem'] = 'item inválida',
  ['commanderror_invalidweapon'] = 'arma inválida',
  ['commanderror_console'] = 'esse comando não pode ser executado a partir do console',
  ...
  ['ammo_bzgas'] = 'can(s)',
  ['ammo_ball'] = 'bola(s)',
  ['ammo_snowball'] = 'bola(s) de neve(s)',
  ['ammo_flare'] = 'flare(s)',
  ...
  ['tint_gold'] = 'skind dourada',
  ['tint_pink'] = 'skin rosa',
  ['tint_army'] = 'skin exercito',
  ['tint_lspd'] = 'skin azul',
  ...
  ['identity_welcome'] = 'Bem-vinda, ~b~%s %s',
