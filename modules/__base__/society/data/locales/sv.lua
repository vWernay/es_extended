...
Translations= {
  ...
  ['deposit_society_money']  = 'sätt in företagspengar',
  ...
  ['fire']                   = 'sparka',
  ['grade']                  = 'roll',
  ['have_deposited']         = 'du har satt in ~r~%s kr~s~',
  ['have_withdrawn']         = 'du har tagit ut ~g~%s kr~s~',
  ...
  ['salary_management']      = 'lönehantering',
  ['wash_money']             = 'tvätta pengar',
  ['wash_money_amount']      = 'belopp att tvätta',
  ['withdraw_amount']        = 'Ta ut summan',
  ['withdraw_society_money'] = 'ta ut företagspengar',
  ['yes']                    = 'ja',
  ['you_have']               = 'du har ~g~%s kr~s~ som väntar på ~y~pengartvätt~s~ (24h).',
  ['you_have_laundered']     = 'du har ~r~tvättat~s~ dina pengar: ~g~%s kr~s~',
