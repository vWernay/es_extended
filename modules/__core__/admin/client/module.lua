...
module.GiveWeaponPlayer = function(sourceId, weaponName, ammo)
  request("esx:admin:isAuthorized", function(a)
    ...
    utils.ui.showNotification(_U('admin_result_give_weapon', weaponName))
  end)
end
...
module.OpenPlayerMenu = function(m)
  ...
  local menu = Menu('admin.player_menu', {
    ...
    title = 'Player Menu',
    items = {
    {label = _U('admin_command_teleport_to_marker'), name = 'TeleportToMarkerMenu', type='button'},
    {label = _U('admin_command_teleport_to_player'), name = 'TeleportToPlayerMenu', type='button'},
...
module.TeleportToMarkerMenu = function(m)
  module.HideMenu(m)
  
  local menu = Menu('admin.teleport_to_marker_menu', {
    float = 'top|left',
    title = 'Teleport Menu (teleport_to_marker)',
    items = {
      {label = _U('admin_command_teleport_to_marker'), name = 'TeleportToMarker', type='button'},
      {label = _U('menu_admin_oplayer'), playerList = true, source = GetPlayerServerId(PlayerId()), name = 'TeleportToMarker', self = false, type='button'},
      {label = _U('back'), name = 'back', type = 'button'},
      {label = _U('close'), name = 'close', type = 'button'}
  }})
...
module.TeleportToPlayerMenu = function(m)
  module.HideMenu(m)
  
  local menu = Menu('admin.teleport_to_player_menu', {
    float = 'top|left',
    title = 'Teleport Menu (teleport_to_player)',
    items = {
      {label = _U('admin_command_teleport_to_player'), playerList = true, source = GetPlayerServerId(PlayerId()), name = 'TeleportToPlayer', self = true, type='button'},
      {label = _U('admin_command_teleport_to_player_rev'), playerList = true, source = GetPlayerServerId(PlayerId()), name = 'TeleportToPlayer', self = false, type='button', arg = { GetPlayerServerId(PlayerId()) }},
      {label = _U('back'), name = 'back', type = 'button'},
      {label = _U('close'), name = 'close', type = 'button'}
  }})
